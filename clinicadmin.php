...
<body onload="initClock()">
    ...
    <div class="wrapper">
        <div class="side_bar">
            ...
            <div class="side_bar_bottom" style="height: max-content;">
                <ul>
                    <li>
            ...
            <div class="main_container">
                ...
                <div style="padding-right:30px; padding-left:30px; padding-top:10px;">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card mb-4 mb-xl-0" style="border-radius: 15px;">
                                <div class="card-header userProfile-font">👤 <b>User Details</b> &nbsp; <a href="" data-toggle="modal" title="Delete" style="float:right;" data-target="#update_modal<?php echo $row['userID'] ?>"><i class="fa fa-pencil" style="color: #245e1c;"></i></a></div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="card mb-4 mb-xl-0" style="border-radius: 15px;">
                                <div class="card-header userProfile-font">🏥 <b>Clinic Details</b> &nbsp; <a href="" data-toggle="modal" title="Edit" style="float:right;" data-target="#clinic_modal<?php echo $row['userID'] ?>"><i class="fa fa-pencil" style="color: #245e1c;"></i></a></div>
                                <div class="card-body text-center">
                                    <div class="userProfile">
                                        <center>
                                            <table class="table">
                        ...
                        <div class="col-md-5">
                            <div class="card mb-4 mb-xl-0" style="border-radius: 15px;">
                                <div class="card-header userProfile-font"> <b>GCash QR</b> &nbsp;
                                    ...
                                    <?php } else { ?>
                                        <a href="" data-toggle="modal" title="Edit" style="float:right;" data-target="#billing_modal"><i class="fa fa-pencil" style="color: #245e1c;"></i></a>
                                    <?php } ?>
                                </div>
                                <div class="card-body text-center">
                                    <div class="userProfile">
        ...
        <?php if ($usertype == 'Administrator') { ?>
            <div class="main_container">
                <div style="padding-right:30px; padding-left:30px; padding-top:10px;">
                    <div class="col-xl-12">
                        <div class="card mb-4 mb-xl-0" style="border-radius: 15px;">
                            <div class="card-header userProfile-font">👤 <b>User Details</b> &nbsp; <a href="" data-toggle="modal" title="Delete" style="float:right;" data-target="#admin_modal<?php echo $row['userID'] ?>"><i class="fa fa-pencil" style="color: #245e1c;"></i></a>
                            </div>
                            <div class="card-body text-center">
                                <div class="userProfile">
                                    <center>
                            ...
                            ?>
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="afname" value="<?php echo $row['FirstName'] ?>" class="form-control" />
                                    </div>
                                    <div class="col-md-4">
                                        <label>Middle Name</label>
                                        <input type="text" name="amname" value="<?php echo $row['MiddleName'] ?>" class="form-control" />
                                    </div>
                                    <div class="col-md-4">
                                        <label>Last Name</label>
                                        <input type="text" name="alname" value="<?php echo $row['LastName'] ?>" class="form-control" />
                                    </div>
                                </div>
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                        <label>Contact No.</label>
                                        <input type="text" name="acnum" value="<?php echo $row['ContactNo'] ?>" class="form-control" />
                                    </div>
                                    <div class="col-md-6">
                                        <label>Birthdate</label>
                                        <input type="date" name="abdate" id="bdate" value="<?php echo $row['Birth_Date'] ?>" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Username</label>
                                    <input type="text" name="ausername" value="<?php echo $row['Username'] ?>" class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="text" name="aemail" value="<?php echo $row['Email'] ?>" class="form-control" readonly />
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            ?>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label>Birthdate</label>
                                        <input type="date" name="bdate" id="bdate" value="<?php echo $row['Birth_Date'] ?>" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Username</label>
