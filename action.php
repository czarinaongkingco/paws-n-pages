...
///////////////////// FOR DELETING PET OWNER PROFILE ////////////////////////////  
if (isset($_POST['delete_user'])) {
    $User_ID = $_POST['User_ID'];
    $adsql = mysqli_query($con, "DELETE FROM address WHERE UserID='$User_ID'");
    $dsql = mysqli_query($con, "DELETE FROM users WHERE UserID='$User_ID'");
    if ($dsql && $adsql) {
        echo 200;
    } else {
        echo "<script>alert('Error deleting data.');</script>";
