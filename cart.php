    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="card" style="border-radius: 15px;">
        <div class="card-body p-4">
          ...
          <div class="col-lg-12">
            <h5 class="mb-3" style="float:left;"><a href="clinic_profile.php?clinicid=<?php echo $clinic_id ?>" style="color: rgb(36,94,28);"><i class="bi bi-chevron-left"></i>&nbsp;Continue shopping</a></h5>
