...
<body>
    ...
    <script>
        $('#edit_modal').on('show.bs.modal', function(e) {
            ...
            if (astatus == 'Completed' || astatus == 'Denied') {
                $('#cancel').hide();
                $('#close').show();
    ...
    if (isset($_POST['cancel'])) {
        ...
        if ($dateDifference >= 3) {
            $query = mysqli_query($con, "UPDATE appointments SET AppointmentStatus='Cancelled', ReasonCancel='$reason' WHERE AppointmentID='$app_ID'");
